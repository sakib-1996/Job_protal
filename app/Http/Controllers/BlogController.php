...
class BlogController extends Controller
{
    ...
    {
        $blogs = Blog:: where('status',true)->with('user')->paginate(3);
        $adds = Add::get();
        return view('front.pages.blog-page', compact('blogs','adds'));
    }
    ...
    public function blogCreate(Request $request)
    {
        ...
        return redirect()->route('company.bloglist')->with('success', 'Request successfull');
    }
